...
class myLogger:
    ...
    verbose_level = myLoggerLevels.INFO
...
def main():
    ...
    myLogger.info("PRONTO?")
    myLogger.log("PRONTO?")
    myLogger.debug("PRONTO?")

    myLogger.success("PRONTO?")
    myLogger.warning("PRONTO?")
    myLogger.error("PRONTO?")
    myLogger.critical("PRONTO?")    
